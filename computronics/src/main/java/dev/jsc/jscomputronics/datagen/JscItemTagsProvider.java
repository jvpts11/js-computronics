 ...
 */
public class JscItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {

    public JscItemTagsProvider(final PackOutput output,
                               final CompletableFuture<HolderLookup.Provider> lookupProvider,
                               final ExistingFileHelper existingFileHelper) {
        super(output, Registries.ITEM, lookupProvider,
                item -> item.builtInRegistryHolder().key(),
                JsComputronics.MODID, existingFileHelper);
    }
