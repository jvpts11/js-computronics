...
/**
 * Opens the client-only power-on self-test screen. Mirrors {@link FirmwareScreenOpener}: the payload
 ...
 */
@FunctionalInterface
public interface PostScreenOpener {
    ...
    final class Holder {
        ...
        @Nullable
        private static PostScreenOpener instance;

        public static void set(final PostScreenOpener opener) {
            instance = opener;
        }
