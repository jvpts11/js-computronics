...
public final class PosixCommands {
    ...
    public static List<CliCommand> all() {
        return List.of(
                ...
                new PackageManagerCommand(dev.jsc.jscomputronics.module.computing.os.PackageManagerKind.APT),
                new PackageManagerCommand(dev.jsc.jscomputronics.module.computing.os.PackageManagerKind.DNF),
                new PackageManagerCommand(dev.jsc.jscomputronics.module.computing.os.PackageManagerKind.PACMAN),
                new PackageManagerCommand(dev.jsc.jscomputronics.module.computing.os.PackageManagerKind.EMERGE));
    }
    ...
    static final class PackageManagerCommand implements CliCommand {
        private final dev.jsc.jscomputronics.module.computing.os.PackageManagerKind kind;

        PackageManagerCommand(final dev.jsc.jscomputronics.module.computing.os.PackageManagerKind kind) {
            this.kind = kind;
        }
        ...
        private void sync(final CliContext ctx) {
            ...
            ctx.out().dim(kind == dev.jsc.jscomputronics.module.computing.os.PackageManagerKind.PACMAN
    ...
    static final class Screenfetch implements CliCommand {
        ...
        private static final java.util.Map<String, dev.jsc.jscomputronics.module.computing.program.cli.CliStyle>
                COLORS = java.util.Map.of(
                        "ubuntu", dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.ORANGE,
                        "debian", dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.MAGENTA,
                        "fedora", dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.BLUE,
                        "arch", dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.CYAN,
                        "gentoo", dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.PURPLE);
        ...
        @Override public void run(final CliContext ctx) {
            ...
            final dev.jsc.jscomputronics.module.computing.program.cli.CliStyle color = COLORS.getOrDefault(
                    info.distroId(), dev.jsc.jscomputronics.module.computing.program.cli.CliStyle.ACCENT);
