...
import dev.jsc.jscomputronics.module.computing.operation.payload.RackBayPowerPayload;
...
public class ServerRackScreen extends AbstractContainerScreen<ServerRackMenu> {
    ...
    private void renderRackTooltip(final GuiGraphics g, final int mouseX, final int mouseY) {
        ...
        final dev.jsc.jscomputronics.module.computing.rack.RackChassis carriedChassis =
                dev.jsc.jscomputronics.module.computing.item.ServerItem.chassisOf(carried);
