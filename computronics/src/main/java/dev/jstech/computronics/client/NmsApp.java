...
import dev.jstech.computronics.operation.payload.IqlFileListPayload;
import dev.jstech.computronics.operation.payload.IqlResultPayload;
import dev.jstech.computronics.operation.payload.NmsSchemaPayload;
import dev.jstech.computronics.operation.payload.OpenIqlFilePayload;
import dev.jstech.computronics.operation.payload.RequestIqlFileListPayload;
import dev.jstech.computronics.operation.payload.RequestNmsSchemaPayload;
...
public final class NmsApp implements IDesktopApp {
    ...
    private dev.jstech.computronics.client.os.OsSkin osSkin =
            dev.jstech.computronics.client.os.OsSkin.fallback();
