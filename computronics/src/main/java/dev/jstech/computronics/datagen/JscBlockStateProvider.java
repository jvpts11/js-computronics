...
public class JscBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        horizontalBlock(ComputingModule.FLOPPY_DRIVE.get(),
                s -> s.getValue(dev.jstech.computronics.os.media.MediaReaderBlock.LOADED) ? floppyActive : floppyIdle);
        ...
        horizontalBlock(ComputingModule.CD_DRIVE.get(),
                s -> s.getValue(dev.jstech.computronics.os.media.MediaReaderBlock.LOADED) ? cdActive : cdIdle);
        ...
        horizontalBlock(ComputingModule.DOCK_STATION.get(),
                s -> s.getValue(dev.jstech.computronics.os.media.MediaReaderBlock.LOADED) ? dockDocked : dockIdle);
