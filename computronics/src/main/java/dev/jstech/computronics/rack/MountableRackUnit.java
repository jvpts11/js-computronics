 ...
 */
package dev.jstech.computronics.rack;
 ...
 * eight U.
 */
public interface MountableRackUnit {
    ...
    @Nullable
    static MountableRackUnit of(final ItemStack stack) {
        return stack.getItem() instanceof MountableRackUnit unit ? unit : null;
    }
    ...
    static RackLayout.Unit unitAt(final ItemStack stack, final int topU) {
        final MountableRackUnit unit = of(stack);
