 ...
 */
package dev.jstech.computronics.registry;
...
public final class JscCreativeModeTabs {
    ...
    private static net.minecraft.world.item.Item mediumFor(
            final dev.jstech.computronics.os.media.MediaFormat format) {
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        for (final dev.jstech.computronics.os.OsDef os
                            ...
                            final ItemStack disc = new ItemStack(mediumFor(
                                    dev.jstech.computronics.os.media.InstallMedia.forSystem(os.minEra())));
                        ...
                        for (final dev.jstech.computronics.os.ProgramSpec program
                            ...
                            final ItemStack disc = new ItemStack(mediumFor(
                                    dev.jstech.computronics.os.media.InstallMedia.forProgram(
