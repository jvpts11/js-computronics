...
public class ServerItem extends Item
    ...
    public ServerItem(final Properties properties) {
        this(properties, dev.jstech.computronics.rack.RackChassis.SERVER);
    }
    ...
    public dev.jstech.computronics.rack.RackChassis chassis() {
        return chassis;
    }

    /** The chassis of a stack, or null when the stack is not a server. */
    @Nullable
    public static dev.jstech.computronics.rack.RackChassis chassisOf(final ItemStack stack) {
    ...
    public net.minecraft.world.InteractionResultHolder<ItemStack> use(
        ...
        if (!level.isClientSide() && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
            serverPlayer.openMenu(new net.minecraft.world.SimpleMenuProvider(
                    (id, inv, p) -> new dev.jstech.computronics.menu.ServerAssemblyMenu(id, inv, hand),
