...
import dev.jsc.jscomputronics.module.computing.operation.payload.RequestSettingsPayload;
import dev.jsc.jscomputronics.module.computing.operation.payload.SetSettingPayload;
import dev.jsc.jscomputronics.module.computing.operation.payload.SettingsSnapshotPayload;
    ...
    private void system(final GuiGraphics g, final Font font, final int x, int y, final int w,
        ...
        if (monitorPos != null) {
            ...
            hits.add(new Hit(x, y, bw, 13, () -> PacketDistributor.sendToServer(
                    new dev.jsc.jscomputronics.module.computing.operation.payload.RequestFirmwarePayload(
                            host, monitorPos))));
        }
    }
        ...
        for (final String id : data.installed()) {
            ...
            hits.add(new Hit(bx, y - 1, bw, 11, () -> {
                PacketDistributor.sendToServer(
                        new dev.jsc.jscomputronics.module.computing.operation.payload.UninstallProgramPayload(host, id));
