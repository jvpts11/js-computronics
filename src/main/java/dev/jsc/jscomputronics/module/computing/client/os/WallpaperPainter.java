...
/**
 * Paints the desktop wallpaper for each Panes OS, evoking the real Windows background of that era
 * instead of a flat colour fill: Panes 95 a deep teal with a soft vertical shade, Panes XP a
 * Bliss-style sky over a rolling green hill, and Panes 11 a deep-blue gradient with a soft central
...
final class WallpaperPainter {
    ...
    static final String[] STYLES = {"", "win95", "winxp", "win11"};
    ...
    private static String defaultStyle(final ResourceLocation osId) {
    ...
    /** Panes 95: the classic teal, lifted from flat by a subtle top-to-bottom shade. */
    ...
    /** Panes XP: a Bliss-style sky fading to the horizon over a rolling green hill. */
    ...
    /** Panes 11: a deep-blue gradient with a soft central bloom. */
