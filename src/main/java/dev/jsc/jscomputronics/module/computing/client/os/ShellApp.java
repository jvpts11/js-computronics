...
import dev.jsc.jscomputronics.module.computing.os.DesktopEnvironmentDef;
...
public final class ShellApp implements DesktopApp {
    ...
    public ShellApp(final BlockPos host, final ResourceLocation desktopId) {
        ...
        final DesktopEnvironmentDef chrome = desktopId == null
                ? null : dev.jsc.jscomputronics.module.computing.os.OsRegistry.getDesktop(desktopId);
        this.posix = chrome != null && switch (chrome.panelStyle()) {
            case KDE, GNOME, CINNAMON -> true;
            default -> false;
        };
        final dev.jsc.jscomputronics.module.computing.os.ProgramSpec promptSpec =
                dev.jsc.jscomputronics.module.computing.program.Programs.get(
                        dev.jsc.jscomputronics.module.computing.program.Programs.COMMAND_PROMPT);
        ...
        if (chrome != null && chrome.panelStyle() == dev.jsc.jscomputronics.module.computing.os.PanelStyle.FRAMES_11) {
