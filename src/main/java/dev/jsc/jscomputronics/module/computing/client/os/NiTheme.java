...
/**
 * The Network Interactor's content palette for one Panes era. The window chrome (title bar, border) is
...
public record NiTheme(int windowBg, int field, int fieldText, int edge, int text, int dim,
    ...
    /** Panes 95: bevelled grey, navy selected tab, dark-green status. */
    ...
    /** Panes XP (Luna): cream body, white fields, blue section headers, green selected tab. */
    ...
    /** Panes 11: flat light, rounded look, system-blue accent. */
